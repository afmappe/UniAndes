...
Heroku: https://arcane-sea-79165.herokuapp.com/psp
...
3. Ejecute el siguiente comando: mvn package
4. Ejecute el siguiente comando: java -cp target/program4-1.0.jar edu.uniandes.ecos.PSP2.App.App
